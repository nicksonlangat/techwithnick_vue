      ...
      <div class="grid grid-cols-3 ml-6 mt-6 gap-x-8">
        <div class="bg-[#18181b] pb-2">
          ...
          <div class="flex  py-2 justify-between">
            <a href="#contact" class="mt-8 ml-2 border border-white rounded-full px-8 py-2 text-white hover:bg-white hover:text-[#0F172A] duration-300 transition-colors">Demo</a>
            <a href="#contact" class="mt-8 mr-2 border border-white rounded-full px-8 py-2 text-white hover:bg-white hover:text-[#0F172A] duration-300 transition-colors">Code</a>
          </div>
          </div>
        </div>
        <div class="bg-[#18181b] pb-2">
