<template>
    <div>
        ...
        <div class="container mx-auto mt-32 pb-4">
            
            <div id="projects" class="mt-20 pb-20">
            <div class="mt-8 grid grid-cols-3 gap-x-6 gap-y-16">
            ...
            <div id="contact" class="mt-10 flex justify-between gap-6">
                <div class="w-1/4 rounded-2xl">
                    
                   
                    <img class="rounded-2xl h-80 w-full object-cover transition-all duration-300 cursor-pointer" src="../assets/image_processing20220305-7813-19y4c1j.png" alt="">
               
                </div>
                <div class="bg-[#14171a] w-1/2 rounded-2xl">
                    <div class="flex mt-12 ml-8">
                        <div>
                            ...
                            <h1 @click="goToContact" class="hover:animate-headShake mt-8 cursor-pointer font-base inline-flex gap-64 text-[#ff669e] font-bold text-4xl mr-4">
                                Get in touch now
                                <span class="mt-1">
                ...
                <div class="w-1/4 rounded-2xl">
                    ...
                    <img class="rounded-2xl h-80 w-full object-cover transition-all duration-300 cursor-pointer" src="../assets/original-996a59b178dc23c23856efbbcc219b29.webp" alt="">
            ...
            <div class="container mt-4 flex font-base justify-between w-1/3 mx-auto py-2">
